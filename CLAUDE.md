...
- The page **title** in `components/notes/note-editor.tsx` is still a bare `contentEditable` — edits there are not captured and never saved. (The body is real: see the BlockNote section below.)
